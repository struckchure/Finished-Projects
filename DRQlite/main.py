...
class Question(QGroupBox):
    ...
    def a_slot(self):
        ...
        self.question_collection[int(self.question_num) - 1] = (
            "A",
            self.a_label.text(),
        )
...
class Login(QDialog):
    ...
    def initialization(self):
        ...
        self.dialog_layout.addWidget(
            self.dialog_stacked_widget, stretch=0, alignment=Qt.AlignCenter
        )
...
question_dictionary = {
    ...
    "answers": ["86 years", "5", "A primate", "Bitten by a radioactive Spider", "60"],
}


database_dictionary = {"usernames": [], "passwords": [], "emails": []}
