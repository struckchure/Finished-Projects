...
Q = {'What is the only sea on Earth with no coastline?', 'What is the largest country based on surface area?',
     'What is the official language of the Canadian province Quebec?', 'What is the longest river in South America?',
     ...
     'What is the largest lake in Africa?', 'Which city is located both in Asia and Europe?',
