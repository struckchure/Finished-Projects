...
class QuizResults(QGroupBox):
    ...
    def centralWIDGET(self):
        ...
        self.quiz_day_label = QLabel("Quiz Results")
    ...
    def quizTABLE(self):
        try:
            self.central_mid_layout.addWidget(
                TableTools.AvailResultsDef(), stretch=0, alignment=Qt.AlignHCenter
            )
    ...
    def distributeTABLE(self):
        try:
            ...
            for q in self.quiz_result:
                self.central_mid_layout.addWidget(
                    TableTools.AvailResults(q[0], self.table_index, q[1], q[3]),
                    stretch=0,
