...
class Quiz(QGroupBox):
    ...
    def centralWIDGET(self):
        ...
        self.quiz_title_layout.addWidget(
            self.quiz_topic, stretch=0, alignment=Qt.AlignTop
        )
        ...
        self.background_stacked_widget.addWidget(
            SetQuiz.SetQuiz(self.background_stacked_widget)
        )
        self.background_stacked_widget.addWidget(
            CheckQuiz.CheckQuiz(self.background_stacked_widget)
        )
        self.background_stacked_widget.addWidget(
            QuizResults.QuizResults(self.background_stacked_widget)
        )
        self.background_stacked_widget.addWidget(
            QuizCandidates.QuizCandidates(self.background_stacked_widget)
        )
